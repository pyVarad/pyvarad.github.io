...
Varad's Blog is a minimal blog built with SASS and focuses on long form blog posts. It is meant to be used as a starting point for a personal blog/website.

If you enjoy Varad's Blog, share your experience and tag [@pyVarad](https://twitter.com/pyVarad).
...
<!-- Dark Mode support preview removed -->

## Setup

1. [Install Jekyll](http://jekyllrb.com)
2. Fork the [Varad's Blog repo](http://github.com/pyVarad/varads-blog)
3. Clone it
...
This is [MIT](LICENSE) with no added caveats, so feel free to use this blog on your site without linking back to me or using a disclaimer.
